...
# Create an Measurement Set Antenna table 
# using the values from a location file.
# Stephen Bourke, JIVE
# September 2009
#
# edited by Maciej Serylak, SKA SA
# August 2016
#
# Version: 20160803
#
...
#location_file = prog_dir + '/NenuFAR_locations.dat'
...
# full planned NenuFAR array
NENUFAR = ['MR00', 'MR01', 'MR02', 'MR03', 'MR04', 'MR05', 'MR06', 'MR07', 'MR08', 'MR09', 'MR10',
           'MR11', 'MR12', 'MR13', 'MR14', 'MR15', 'MR16', 'MR17', 'MR18', 'MR19', 'MR20', 'MR21',
           'MR22', 'MR23', 'MR24', 'MR25', 'MR26', 'MR27', 'MR28', 'MR29', 'MR30', 'MR31', 'MR32',
           'MR33', 'MR34', 'MR35', 'MR36', 'MR37', 'MR38', 'MR39', 'MR40', 'MR41', 'MR42', 'MR43',
           'MR44', 'MR45', 'MR46', 'MR47', 'MR48', 'MR49', 'MR50', 'MR51', 'MR52', 'MR53', 'MR54',
           'MR55', 'MR56', 'MR57', 'MR58', 'MR59', 'MR60', 'MR61', 'MR62', 'MR63', 'MR64', 'MR65',
           'MR66', 'MR67', 'MR68', 'MR69', 'MR70', 'MR71', 'MR72', 'MR73', 'MR74', 'MR75', 'MR76',
           'MR77', 'MR78', 'MR79', 'MR80', 'MR81', 'MR82', 'MR83', 'MR84', 'MR85', 'MR86', 'MR87',
           'MR88', 'MR89', 'MR90', 'MR91', 'MR92', 'MR93', 'MR94', 'MR95']

NENUFAR_22 = ['MR00', 'MR01', 'MR02', 'MR03', 'MR04', 'MR05', 'MR06',
              'MR07', 'MR08', 'MR09', 'MR10', 'MR11', 'MR12', 'MR13',
              'MR14', 'MR15', 'MR16', 'MR17', 'MR18', 'MR19', 'MR20',
              'MR21']

NENUFAR_16 = ['MR00', 'MR01', 'MR02', 'MR03', 'MR04', 'MR05', 'MR06',
              'MR07', 'MR08', 'MR09', 'MR10', 'MR11', 'MR12', 'MR13',
              'MR14', 'MR15']

NENUFAR_15 = ['MR00', 'MR01', 'MR02', 'MR03', 'MR04', 'MR05', 'MR06',
              'MR07', 'MR08', 'MR09', 'MR10', 'MR11', 'MR12', 'MR13',
              'MR14']
...
def lofar_size(name):
  if (name.startswith('CS') or name.startswith('RS')) and name.endswith('LBA'):
    ...
    raise ValueError, "%s doesn't appear to be a LOFAR antenna!" % name
...
# Get antenna parmeters from SCHED file
ant_list = []
have_name = False
have_xyz = False
try:
...
for line in inf:
  ...
  if end_block.match(line):
    ...
    if code in [ant['NAME'] for ant in ant_list]:
      ...
      ant_parms = {'POSITION': [x,y,z], 'MOUNT': mount, 'STATION': name, 'NAME': code}
      if code in ANT_SIZE:
...
table = casacore.tables.table(ms_out, desc, nrow = len(ant_list), readonly = False)
